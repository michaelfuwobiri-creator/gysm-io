...
export const MEDIA_CREDIT_COST: Record<MediaKind, number> = {
  ...
  inpaint: 150, // ~$0.05/megapixel x2 margin, assuming ~1MP average (Fal.ai flux-pro/v1/fill) -- scales with actual image size in reality
};
...
export const SYNCHRONOUS_MEDIA_KINDS: readonly MediaKind[] = ["image", "captions", "tts", "voice-clone", "edit", "script", "sound-effect", "voice-enhance", "export", "virtual-try-on", "inpaint"];
