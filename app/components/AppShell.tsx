...
// built from GYSM's own light identity -- same off-white background and
// palette as the public homepage (see app/page.tsx) -- rather than
// copying anyone's actual markup or branding assets.
//
